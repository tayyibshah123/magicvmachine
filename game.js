...
const Game = {
    ...
    updateTutorialStep() {
        ...
        // Apply transparent style to ALL steps now (as requested)
        text.classList.add('tutorial-transparent');

        // --- 2. DYNAMIC POSITIONING LOGIC ---
        let topPercent = '40%'; // Default (Original Position)
        ...
        if (isMobile) {
            ...
            switch (this.tutorialStep) {
                case 0: // Intro
                case 4: // Drag Defend Die (Original)
                case 5: // End Phase (Original)
                case 6: // QTE Defend (Original)
                case 8: // Summon Die (Original)
                case 9: // Destroy Target (Original, but transparent)
                    topPercent = '40%'; 
                    break;
                case 1: // Enemy Scan (New Lower)
                case 2: // Drag Attack Die (New Lower)
                case 3: // QTE Attack (New Lower)
                case 7: // Reroll Button (New Lower)
                    topPercent = '75%'; 
                    break;
            }
        }
        ...
        switch(this.tutorialStep) {
            ...
            case 9: 
                // Case 9 is handled by the new tutorial-transparent class applied globally above.
