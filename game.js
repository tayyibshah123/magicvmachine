...
const Game = {
    ...
    bindEvents() {
        ...
        const attachButtonEvent = (id, callback) => {
            ...
            // Stop propagation on touch to prevent ghost clicks through UI
        ...
        // --- FIX: MOBILE TUTORIAL ADVANCE ---
        // Explicitly listen for touches on the overlay for Step 0
