    ...
    bindEvents() {
        ...
        const attachButtonEvent = (id, callback) => {
            ...
            btn.onclick = (e) => {
                ...
                // NEW: Ensure music starts on any button click
                AudioMgr.startMusic();
        ...
        attachButtonEvent('btn-tutorial-mode', () => this.startTutorial());
         // Updated Finish Story Button
        attachButtonEvent('btn-finish-story', () => {
            // FIX: Reset HUD Z-Index
        ...
        attachButtonEvent('btn-debrief', () => { 
            AudioMgr.playSound('click'); 
            this.tutorialData = TUTORIAL_PAGES; // Load Standard Help
            this.changeState(STATE.TUTORIAL); 
        });
        attachButtonEvent('btn-back-tutorial', () => { 
            AudioMgr.playSound('click'); 
            
            // FIX: Reset data back to standard Help Text for next time
        ...
        window.addEventListener('click', (e) => {
            ...
            if (this.currentState === STATE.TUTORIAL_COMBAT) {
                // Step 0: Intro -> Click anywhere to advance
                ...
                // Step 1: Click Enemy -> Just pass it to the interaction handler
                // FIX: Removed "e.target.id === 'tutorial-overlay'" check because Canvas is now on top
        ...
        const handleInteraction = (e) => {
             ...
             // Update mouse coordinates for click event just in case
             const rect = this.canvas.getBoundingClientRect();
             const scaleX = this.canvas.width / rect.width;
             const scaleY = this.canvas.height / rect.height;
             
             // Prefer touch, then mouse
             ...
             if(e.touches && e.touches.length > 0) {
                ...
                clientY = e.touches[0].clientY;
                 ...
                 // Handle touchend case
                clientX = e.changedTouches[0].clientX;
                clientY = e.changedTouches[0].clientY;
             }

             // Only update if we have valid coords (might be missing on pure click events)
             if (clientX) {
