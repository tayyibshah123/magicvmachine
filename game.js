...
const Game = {
    ...
    updateTutorialStep() {
        ...
        // --- 2. DYNAMIC POSITIONING LOGIC (Mobile-friendly) ---
        let topPercent = '40%'; // Default position (Middle-Upper)
        ...
        if (isMobile) {
            ...
            switch (this.tutorialStep) {
                case 0: // Intro
                case 4: // Drag Shield Die
                case 5: // End Phase
                case 6: // QTE Defend
                case 8: // Summon Die
                    topPercent = '75%'; // Low, above the dice/End Phase button
                    break;
                case 1: // Enemy Scan
                case 2: // Drag Attack Die
                case 3: // QTE Attack
                case 7: // Reroll Button
                    topPercent = '45%'; // Middle-Upper, safe from enemy and dice
                    break;
                case 9: // Destroy Target (Transparent, positioned near enemy/player center)
                    topPercent = '50%';
                    break;
            }
            ...
            // Apply default desktop position (all at 40% on desktop)
            text.style.top = '40%';
            text.style.transform = 'translateX(-50%) translateY(-50%)';
        }
        // ----------------------------------------------------
        ...
        switch(this.tutorialStep) {
            ...
            case 9: 
                // Special case: Remove box, keep text.
