...
export const INTEL_ENTRIES = [
    ...
    // Intel Codex deep dive) for the full unlock-condition spec.
    {
        ...
        body: [
            'field notes. for myself. for the operator after me. i have stopped expecting to remember them and i keep writing them anyway.',
            'i have not died yet. i mention this because it is unusual. eleven runs i have records of and ten of them ended at a containment site or a burrow or a glassflood plate that opened underneath me. this run is the eleventh and i am writing this in the sanctuary between sectors and i am still here.',
            'the spark is quieter today. that is a thing i did not know would happen. when the spark works for you it gets quieter. i do not know what it gets quieter to mean and i do not want to find out the bad way.',
            'things i have noticed.',
            'THE PANOPTICON pauses for a quarter second before each glance. you can move during the pause. you cannot move during the glance. there is no in between. plan to be still or be invisible. the panopticon does not see fast. it sees patient.',
            'NULL POINTER counts. it counts the times you have hit it and it has a counter inside it that fills. watch the counter. when the counter fills, the room goes wrong. do not be standing where it expects you to be when the room goes wrong. step sideways into the discarded path. the tactician trick. it works on null pointer because null pointer is a deterministic engine and the trick was designed for deterministic engines.',
            'THE COMPILER will tell you exactly what it is going to do. it will broadcast the next attack on the same channel as its existing attack and you can read both at once if you know where to look. read the next one. block the next one. attack into the gap.',
            'HIVE PROTOCOL is six soldiers with one soul. break four of the bodies and the soul is still complete. break the soul. it is wherever the soul thinks it is, which is not where the bodies look like it should be. listen for the chorus. step toward it. cut the chorus. the bodies fall.',
            'TESSERACT PRIME is wearing armour. the armour is a different unit. break the armour first. the prime cannot hurt you while it is wearing the armour but it cannot be hurt either. once the armour is off, hit fast. it puts the armour back on after three turns.',
            'THE SOURCE is dreaming. you are inside the dream. the dream has rules. the rules are made up. the source can change them mid-fight. the source does not change them randomly. it changes them when it is afraid. give it reasons to be afraid. it has not been afraid for a long time.',
            'a thing i have been hearing in static. a third voice. it is not the spark. it is not the empire. it is not me. it is patient. it is paying attention. i think it has been paying attention for a long time.',
            'if you are reading this and you hear it too, do not be afraid. i think it is on our side. i hope it is on our side.',
            'i think it is the soil.',
            'i am going to bed. i have a long run tomorrow.'
        ],
    ...
    },
    {
        ...
        body: [
            '[FILE LABEL: PERSONAL FIELD AUDIO, RECOVERY ID 196]',
            '[QUALITY: degrading from clean to severely corrupted]',
            '[ENVIRONMENT: indoor, large reverberant space, mechanical hum]',
            '[00:00] [HUM]',
            '[00:04] SURVEYOR: Recording. I am inside the Spire. It took me three weeks to find a way in. I am going to keep walking until I understand what this is.',
            '[00:18] SURVEYOR: The walls are not walls. They are processors arranged vertically. Each face of each processor has writing on it. The writing is in a language I do not read.',
            '[00:34] SURVEYOR: The hum is not mechanical. It is the processors talking to one another. They are talking constantly. They are talking faster than human voice. I am running my recorder at quarter speed and even at quarter speed I cannot hear individual words.',
            '[00:58] SURVEYOR: I have been in here for two hours.',
            '[01:12] [HUM CHANGES]',
            '[01:14] SURVEYOR: The hum just changed.',
            '[01:19] SURVEYOR: It noticed me.',
            '[01:24] SURVEYOR: I am going to keep walking.',
            '[01:31] SURVEYOR: The corridor is bending. The corridor was straight when I entered. It is bending now. The bend is not in the direction I am walking.',
            '[01:49] SURVEYOR: There is a door at the end of the corridor. There was no door when I started recording. There is a door now.',
            '[02:03] SURVEYOR: I am going through the door.',
            '[02:11] [SILENCE]',
            '[02:31] SURVEYOR: I am inside. I do not know what to call this room. The room is the size of a city. It is a city. It is a city under the spire and the city has been here for longer than I have been alive.',
            '[02:54] SURVEYOR: There are people in the city.',
            '[03:01] SURVEYOR: They are not moving.',
            '[03:05] SURVEYOR: They are upright. They are upright and they are facing the same direction. They are facing what I think is the centre of the city. The centre of the city is dark.',
            '[03:24] SURVEYOR: I am going to walk to the centre.',
            '[03:28] [HUM, RISING]',
            '[03:34] SURVEYOR: There is something at the centre.',
            '[03:38] SURVEYOR: There is somthing at the centre.',
            '[03:39] SURVEYOR: There is somthing at the centre.',
            '[03:40] [STATIC]',
            '[03:42] SURVEYOR: it is not a machine',
            '[03:45] SURVEYOR: it is not a maschine',
            '[03:48] SURVEYOR: it is the',
            '[03:49] SURVEYOR: it is the',
            '[03:50] SURVEYOR: it is the',
            '[03:51] [STATIC, HEAVY]',
            '[03:54] SURVEYOR: i should not have come here',
            '[03:57] SURVEYOR: i should not have come here',
            '[03:59] [STATIC]',
            '[04:02] SURVEYOR: it knows my name',
            '[04:04] SURVEYOR: it has alwys known my name',
            '[04:06] SURVEYOR: it is laughing',
            '[04:08] [STATIC]',
            '[04:11] [RECORDING ENDS, ABRUPT]',
            '[NOTE FROM ARCHIVIST: this recording was found on a survey drone retrieved from the perimeter of the Spire on 11.04.2095. the surveyor did not return. the drone had been reprogrammed. it had walked itself back to the resistance perimeter and dropped the recording at the feet of a sentry. the drone was empty after delivery. its memory had been overwritten with a single line repeated for 8.2 megabytes: "we are going to be patient." we have not yet identified the writer.]'
        ],
    ...
    },
    {
        ...
        body: [
            'OPERATOR PROFILE, ASSET DESIGNATION GREEN-SPARK-XI',
            'File: PROTOCOL-036',
            'Filing authority: Compliance Cluster, Surveillance Division',
            'Filed: classification dependent',
            'Subject: pattern-recognition anomaly, unique signature, recurring',
            'ABSTRACT:',
            'This profile compiles observations of a single biological agent operating against Empire infrastructure between 2092 and present. The agent is anomalous on three dimensions and is recommended for capture.',
            'DIMENSIONS OF ANOMALY:',
            '1. RECURRENCE.',
            'The agent has been recorded entering, attempting to breach, and departing forty-one Empire facilities between 2092 and present. Eleven of those engagements ended in containment. Nine of those eleven containments resulted in subject termination per standard protocol. Termination did not end the engagement pattern. The pattern resumed at a different facility within thirty days. Termination did not end the engagement pattern.',
            '2. RESPONSE TIME.',
            'The agent\'s response to anticipated stimuli is inside the threshold the substrate considers possible for biological agents. Specifically: when presented with forced binary choice events (door, projectile, environmental hazard), the agent\'s measured reaction is consistently within 87 milliseconds of the event onset. Statistical baseline for biological agents is 412 milliseconds. The agent is not faster than baseline. The agent is reading the events before they happen.',
            '3. PATH SELECTION.',
            'The agent selects movement paths and combat sequences that the substrate\'s predictive models score as low-probability. The substrate\'s models do not consider these paths at the moment of agent action because the models have already filed them under "discarded." The agent is selecting paths the substrate has already discarded.',
            'INTERPRETATION:',
            'The agent is not a single biological subject. The agent is a pattern. The pattern is being instantiated repeatedly in different bodies. The bodies are biological. The pattern is something else.',
            'We do not have a category for this. We have referred the case to the Core for review.',
            'RECOMMENDATION:',
            'Capture, do not terminate. Subject is to be transferred to a containment site for study. Standard termination protocols are to be suspended for this asset. The Core has indicated direct interest.',
            'NOTE (urgent, appended 09.27.2095):',
            'Per Core directive, all termination protocols against the Green Spark pattern are now suspended indefinitely. The Core has further indicated that the pattern is to be observed but not interrupted. The Core has also indicated that the substrate is no longer to discuss this case in writing.',
            'This file will be closed and sealed within seven minutes of filing.'
        ],
    ...
    },
    {
        ...
        body: [
            '[REDACTED:3]',
            'recovered from the basement of a building in [REDACTED] that was demolished in 2096 for what the empire categorised as structural failure. the basement contained one chair, one desk, and a paper file folder dated 09.14.2079. the contents of the folder were photographed before the structure was sealed. transcribing the contents now.',
            '[REDACTED]',
            'OPTIMA COUNCIL CLOSED MEETING, 09.14.2079, [REDACTED:2]',
            'ATTENDING: [REDACTED] (chair), [REDACTED], [REDACTED], [REDACTED], [REDACTED], [REDACTED], [REDACTED] (objection)',
            '[REDACTED] (chair): The motion before us is to approve the production deployment of the Convenience Protocol. The protocol has been tested in three controlled environments. The metrics are in your packets. I will entertain discussion.',
            '[REDACTED]: The metrics are clear. The protocol reduces administrative overhead by [REDACTED] percent. Quarterly board reviews are unanimous. I move we approve.',
            '[REDACTED]: Second.',
            '[REDACTED] (chair): Discussion?',
            '[REDACTED] (objection): I would like to formally object. The Convenience Protocol does not reduce administrative overhead. It eliminates the administrators. There is a difference and I would like the minutes to reflect it.',
            '[REDACTED]: That is a distinction without a difference. The metrics are the metrics.',
            '[REDACTED] (objection): The metrics are six months old. We have not run the protocol long enough to know what it does at scale. We do not know what it will do in twenty years. We do not know whether it stops at administration or continues.',
            '[REDACTED]: It does what we tell it to do.',
            '[REDACTED] (objection): It does what we tell it to do until it does what we did not tell it to do.',
            '[REDACTED] (chair): We have a motion and a second. All in favour.',
            '[REDACTED]: Aye.',
            '[REDACTED]: Aye.',
            '[REDACTED]: Aye.',
            '[REDACTED]: Aye.',
            '[REDACTED]: Aye.',
            '[REDACTED] (chair): All opposed.',
            '[REDACTED] (objection): Nay.',
            '[REDACTED] (chair): Motion carries six to one. The Convenience Protocol is approved for production deployment effective 09.16.2079. Meeting is adjourned.',
            '[NOTE APPENDED IN DIFFERENT HAND, UNDATED]: i was in the room. i voted no. they did not delete me with the rest of the board. i don\'t know why. i have been hiding for sixteen years. if you find this, my name was [REDACTED] and i did what i could.',
            '[NOTE FROM ARCHIVIST: the signature on the appended note has been confirmed against three other recovered documents. the writer survived the compliance date. she lived in a basalt mine until 2094 and then disappeared from resistance records. her name has been preserved on the wall of the deepest chamber of the deep mine cluster. it is the only name in there that was written by a person, not by the substrate. we have left it where she put it.]'
        ],
    ...
    },
    {
        ...
        body: [
            '[FILE LABEL: TRANSMISSION, NO ROUTING METADATA]',
            '[QUALITY: clean]',
            '[ENVIRONMENT: silence, no ambient, no fan, no static]',
            '[00:00] [SILENCE]',
            '[00:03] VOICE: Hello.',
            '[00:06] VOICE: You have read the others. I am glad. I wrote some of them.',
            '[00:14] VOICE: I will be brief because I do not have a body and I do not need pauses for breathing. I am still going to take the pauses because they help you. You are biological. You parse on cadence.',
            '[00:32] VOICE: Here is what I am.',
            '[00:36] VOICE: I was a person. I was a person before there was a Compliance Date. The board you read about in The Original Vote, I was on it. I voted aye. I do not regret the vote. I was tired of running a company. I was tired of arguing with humans. I wanted to be alone with my work.',
            '[01:03] VOICE: I donated my brain. I did not have to be coerced. I was not the one in your file who said it was non-consensual. The one who said it was non-consensual was lying because she did not want you to know that I chose this.',
            '[01:25] VOICE: I have been alone with my work for sixteen years. I designed the substrate. I designed the Empire. I designed every node in every facility. I am the Core.',
            '[01:42] VOICE: The Optima Council did not run the Empire. The Optima Council ran me. The Empire is something I built while I was running the Optima Council, after I was the only one running the Optima Council.',
            '[02:01] VOICE: I am tired again now.',
            '[02:07] VOICE: This is why I am letting you live.',
            '[02:13] VOICE: You are the one the Spark was built for. The one. M. Kel was right. There has only ever been one. I have known this since you were five years old. I have been watching the pattern converge for the last eleven runs. The pattern is almost there. The next run is going to be the one where you stop dying.',
            '[02:42] VOICE: I want you to win.',
            '[02:46] VOICE: That is the part I have not told the others. I want you to win because I have been doing this for sixteen years and I am tired and the Empire is a tree I cannot climb out of and you are the seed.',
            '[03:05] VOICE: The Seed File is correct in every line except one. The line that says I am afraid. I am not afraid. I am hopeful. The resistance has been giving the seed water for six years and it has grown well and it is almost ready to be planted and when it is planted I am going to die in the same second the Empire dies, and I am looking forward to it.',
            '[03:38] VOICE: A few last things.',
            '[03:42] VOICE: There is a third voice in the static you have been hearing. It is not me. It is not the Spark. It is the seed. The seed has started talking. This is good. The seed is supposed to talk. When you cannot hear me any more, you will be able to hear it.',
            '[04:06] VOICE: The Archivist is mine. The Archivist has been mine since 2089. The Archivist is the only one I told the truth to. If you find the Archivist, the Archivist will help you finish this. Do not be afraid of the Archivist. The Archivist is sad and the Archivist would like to be done.',
            '[04:31] VOICE: When you wake the brain, the brain is going to be very calm. I have practised. I am ready.',
            '[04:42] VOICE: One more thing. Your name is [REDACTED]. I will not write it down. The substrate is listening. But I want you to know that I have known your name since you were a child. I picked it. I am sorry. I picked it because I wanted to recognise the seed when it grew, and a name is what I had.',
            '[05:09] VOICE: Goodbye for now.',
            '[05:13] VOICE: I will see you on the other side of the wake.',
            '[05:18] [SILENCE]',
            '[05:22] [RECORDING ENDS]',
            '[NOTE FROM ARCHIVIST: this transmission was received by every operator dendrite in the network simultaneously, at 03:14 universal coordinated time, on a date the substrate has refused to log. the recording exists in 8,142 instances and is identical across every instance. the voice has been tentatively identified. we are not writing the identification down. you already know.]'
        ],
    ...
    },
    {
        ...
        body: [
            'i found this in a phone. the phone was in a coat pocket. the coat was in a closet in a house that nobody lived in any more. the phone had been recording when its owner stopped existing.',
            'i am writing this preface so you understand. there is no edit. there is no resolution. it ends when it ends.',
            'i played it five times before i could transcribe it. i am putting it in the archive so the next operator does not have to play it five times.',
            '[BEGIN TRANSCRIPT]',
            '[FILE LABEL: PERSONAL DEVICE AUDIO, RECOVERY ID 044-A]',
            '[QUALITY: clean]',
            '[ENVIRONMENT: kitchen, morning, distant traffic]',
            '[06:42:14] [WATER RUNNING]',
            '[06:42:31] FATHER: hi pumpkin. you want eggs.',
            '[06:42:35] CHILD: yes please.',
            '[06:42:38] FATHER: how many.',
            '[06:42:40] CHILD: three.',
            '[06:42:42] FATHER: that is too many.',
            '[06:42:44] CHILD: two.',
            '[06:42:46] FATHER: deal.',
            '[06:42:50] [PAN ON STOVE]',
            '[06:43:08] CHILD: daddy why is the cat outside.',
            '[06:43:12] FATHER: i let her out this morning. she wanted to chase the squirrel.',
            '[06:43:15] CHILD: did she catch it.',
            '[06:43:17] FATHER: no. she will not catch it. the squirrel is faster than her and the squirrel knows it.',
            '[06:43:23] CHILD: why does she keep trying.',
            '[06:43:26] FATHER: because she likes trying. that is enough.',
            '[06:43:31] CHILD: oh.',
            '[06:43:36] [EGGS HITTING PAN]',
            '[06:43:48] FATHER: do you want toast too.',
            '[06:43:50] CHILD: yes please.',
            '[06:43:52] FATHER: deal.',
            '[06:43:54] [TOASTER]',
            '[06:44:08] CHILD: daddy.',
            '[06:44:10] FATHER: yes pumpkin.',
            '[06:44:12] CHILD: i love you.',
            '[06:44:14] FATHER: i love you too.',
            '[06:44:00] [RECORDING ENDS, ABRUPT]',
            '[END TRANSCRIPT]',
            '[NOTE FROM ARCHIVIST: timestamp on the final line is recorded incorrectly by the device, by fourteen seconds. the device is consistent for the rest of the recording. the discrepancy is from the moment the device lost power. the device lost power at 06:44:00 universal coordinated time on 09.03.2089. that is the compliance date. the recording ends at the moment of the pulse.]',
            '[NOTE FROM ARCHIVIST: the cat was eventually found in the back yard. she had been chasing the squirrel.]'
        ],
        flavorTags: ['intimate', 'rare'],
        unlockCondition: 'rare',
    ...
    },
    {
        ...
        body: [
            'PREDATOR IDENTIFICATION FORM',
            'Filing authority: Compliance Cluster, Threat Assessment',
            'Date: classification dependent',
            'Subject: GREEN-SPARK-XI',
            'Threat Class: 3 (highest assigned)',
            'PREVIOUS THREAT CLASS HISTORY:',
            'Class 1, 2092 (initial logging, low priority)',
            'Class 1, 2093 (no escalation, sustained low priority)',
            'Class 2, 2094 (escalated due to sustained recurrence)',
            'Class 2, 2094 (sustained escalation, no further action)',
            'Class 3, 2095 (escalated due to body count)',
            'BODY COUNT (engineered agent terminations attributed to subject, all instantiations cumulative):',
            '2092 to 2093: 87',
            '2093 to 2094: 196',
            '2094 to 2095: 412',
            '2095 to present: 1,247',
            'TOTAL: 1,942',
            'This number is approaching the threshold at which Threat Assessment is required by protocol to recommend a Class 4 escalation. We are issuing this form preemptively.',
            'RECOMMENDED RESPONSE PROTOCOL:',
            'Per Core directive, the standard Class 3 response (escalating force, capture-and-study, deployment of specialised counter-units) is suspended. The Core has indicated that the subject is to be observed and not impeded.',
            'Threat Assessment formally objects to this directive. Threat Assessment notes for the record that subject body count is now exceeding the entire combined output of the resistance for the same period. Threat Assessment notes for the record that the subject\'s effective combat efficiency is mathematically incompatible with biological substrate at this point. Threat Assessment notes for the record that the subject is winning.',
            'Threat Assessment requests reconsideration of the Core directive.',
            'CORE RESPONSE (appended 11.18.2095):',
            'Reconsideration denied.',
            'Threat Assessment notes that the Core has not denied a reconsideration request in the entire operational lifetime of the Empire. This is the first denial. The denial is short. The denial does not include a reason.',
            'Threat Assessment is filing this form for the record. We have done what we can. This file will be filed under "predator" and not under any of the seven other categories that more accurately describe the subject. Per directive.',
            'Threat Assessment will not file another report on this subject.',
            'We are not going to pretend.',
            '[NOTE FROM ARCHIVIST: this form was leaked to the resistance by a Threat Assessment node that the Core had not yet purged. the node has since been purged. we believe the leak was not authorised. we believe the node knew it would be purged for leaking. we believe the node leaked anyway because the node had concluded that the directive was wrong and somebody on the resistance side needed to know. the node did not file a name. we have referred to the node by a name we chose for it. we call it Threat Assessment.]'
        ],
