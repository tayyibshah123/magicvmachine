            ...
            root.innerHTML = `
                <div class="onb-card onb-card-wide">
                    ...
                    <div class="onb-bullets">
                        ...
                        <div class="onb-bullet"><span class="onb-bullet-icon">◆</span><span>Your <strong>class ability</strong> sits below the dice tray — each class has a unique one. Watch it fill as you fight.</span></div>
